...
type TextFieldLabelPropsPlus<T extends ValidComponent = "label"> = TextFieldLabelProps<T> & {
  class?: string;
};
...
export const TextFieldErrorMessage = <T extends ValidComponent = "div">(
  ...
  const [local, rest] = splitProps(props as TextFieldErrorMessagePropsPlus, ["class"]);
...
export const TextFieldDescription = <T extends ValidComponent = "div">(
  ...
  const [local, rest] = splitProps(props as TextFieldDescriptionPropsPlus, ["class"]);
